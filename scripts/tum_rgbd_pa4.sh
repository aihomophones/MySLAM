#!/bin/bash
# PA4 Training Script: 5 iterations × 3 datasets with delays
# Config: lambda_align=0.1, lambda_iso=0.0 (disabled)

set -e

echo "Running PA4 training on 3 TUM datasets (5 iterations each)..."
...
do
    ...
    ../bin/tum_rgbd \
        ...
        ../results_pa4/tum_rgbd_$i/rgbd_dataset_freiburg1_desk \
        no_viewer
    ...
    ../bin/tum_rgbd \
        ...
        ../results_pa4/tum_rgbd_$i/rgbd_dataset_freiburg2_xyz \
        no_viewer
    ...
    ../bin/tum_rgbd \
        ...
        ../results_pa4/tum_rgbd_$i/rgbd_dataset_freiburg3_long_office_household \
        no_viewer
