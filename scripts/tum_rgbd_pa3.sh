#!/bin/bash
# PA3 Test: L_align + L_iso combined (light weights)
# Purpose: Test combination of depth alignment + isotropy regularization
# NOTE: Before running, update gaussian_mapper.cpp:
#   lambda_align = 0.02f;
#   lambda_var = 0.0f;
#   lambda_iso = 0.003f;

echo "=== PA3 Test: L_align + L_iso (light weights) ==="
...
../bin/tum_rgbd \
    ...
    ../results_pa3/tum_rgbd_$i/rgbd_dataset_freiburg1_desk \
    no_viewer
...
../bin/tum_rgbd \
    ...
    ../results_pa3/tum_rgbd_$i/rgbd_dataset_freiburg2_xyz \
    no_viewer
...
../bin/tum_rgbd \
    ...
    ../results_pa3/tum_rgbd_$i/rgbd_dataset_freiburg3_long_office_household \
    no_viewer
done

echo ""
echo "PA3 Test Complete! Results saved to results_pa3/"
