#!/bin/bash
# PA10: High sensor depth weight (lambda_geo=0.5)
# Testing if higher weight than PA6 (0.2) improves results

set -e

echo "Running PA10 training on 3 TUM datasets (5 iterations each)..."
...
do
    ...
    ../bin/tum_rgbd \
        ...
        ../results_pa10/tum_rgbd_$i/rgbd_dataset_freiburg1_desk \
        no_viewer
    ...
    ../bin/tum_rgbd \
        ...
        ../results_pa10/tum_rgbd_$i/rgbd_dataset_freiburg2_xyz \
        no_viewer
    ...
    ../bin/tum_rgbd \
        ...
        ../results_pa10/tum_rgbd_$i/rgbd_dataset_freiburg3_long_office_household \
        no_viewer
